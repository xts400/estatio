...
public class BrandRepositoryIntegTest extends EstatioIntegrationTest {
    ...
    public static class AllBrandRepository extends BrandRepositoryIntegTest {
    ...
    public static class FindUniqueNames extends BrandRepositoryIntegTest {
    ...
    public static class FindUniqueGroups extends BrandRepositoryIntegTest {
    ...
    public static class FindUniqueBrand extends BrandRepositoryIntegTest {
    ...
    public static class NewBrand extends BrandRepositoryIntegTest {
